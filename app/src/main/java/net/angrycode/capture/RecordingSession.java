...
final class RecordingSession {
    ...
    private int videoSizePercentage = 0;

    private final File outputRoot;
    private final DateFormat fileFormat =
            new SimpleDateFormat("'ScreenCapture_'yyyy-MM-dd-HH-mm-ss'.mp4'", Locale.US);
    ...
    RecordingSession(Context context, Listener listener, int resultCode, Intent data, boolean showCountDown, int videoSizePercentage) {
...
//                windowManager.updateViewLayout(overlayView, overlayView.getLayoutParams());
        ...
        windowManager.addView(overlayView, OverlayView.Companion.createLayoutParams(context));
